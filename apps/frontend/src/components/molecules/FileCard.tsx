...
export const FileCard = ({
  ...
  return (
    <Popover className='flex flex-1 flex-col'>
      ...
      />
      <div className='relative flex max-w-sm flex-1 flex-col text-ellipsis rounded-lg border border-border bg-card p-4 text-card-foreground shadow-sm'>
        ...
        <PopoverPanel className='w-fit-content absolute right-0 top-0 divide-y divide-border rounded-xl bg-popover text-popover-foreground text-sm/6 ring-1 ring-border transition duration-200 ease-in-out [--anchor-gap:var(--spacing-5)] data-[closed]:-translate-y-1 data-[closed]:opacity-0'>
