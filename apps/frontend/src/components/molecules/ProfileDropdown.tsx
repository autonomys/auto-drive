...
export const ProfileDropdown: React.FC = () => {
  ...
  return (
    <div className='relative' ref={dropdownRef}>
      ...
      >
        <div className='flex items-center space-x-2 rounded-full shadow-lg'>
          {user?.oauthAvatarUrl ? (
            ...
            <div className='flex h-9 w-9 items-center justify-center rounded-full border border-gray-100 bg-gray-300 text-white shadow-lg dark:border-gray-500 dark:bg-muted'>
      ...
      {isOpen && (
        <div className='absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-md border border-border bg-popover text-popover-foreground shadow-lg'>
